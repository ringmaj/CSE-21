public class MethodsOverload {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println();
		 * 
		 * init(arr); System.out.println("sumAll output for 5 is " + sumAll(arr,
		 * 5)); System.out.println("sumAll output for 10 is " + sumAll(arr,
		 * 10)); System.out.println("sumAll output for 20 is " + sumAll(arr,
		 * 20)); System.out.println("sumAll output for 15 is " + sumAll(arr,
		 ...
		 * );
		 * 
		 * init(arr); System.out.println("squareSum output for 5 is " +
		 * squareSum(arr, 5)); System.out.println("squareSum output for 10 is "
		 * + squareSum(arr, 10));
		 * System.out.println("squareSum output for 20 is " + squareSum(arr,
		 * 20)); System.out.println("squareSum output for 15 is " +
		 * squareSum(arr, 15)); System.out.println();
		 */
		...
		/*
		 * init(arr); System.out.println("Fibonacci Number 5 is " + fib(arr,
		 * 5)); System.out.println("Fibonacci Number 10 is " + fib(arr, 10));
